...
public class QRCodeGenerator : MonoBehaviour
{
    ...
    private void Start()
    {
        if (qRCodeArea)
        {
            ...
            {
                qRCodeArea.GetComponentInChildren<Text>().text = MobileWebControl.MobileWebController.webServerAddress;
            }
        }
    }
    public Texture2D GenerateQRCode()
    {
        return GenerateQRCode(MobileWebControl.MobileWebController.webServerAddress);
    }
